...
class Console
    ...
    "----------------------------",
    "",
    Rainbow("Vous devez taper une commande pour effectuer une opération").blue,
    "Exemples: " + Rainbow(@@post_cat).green + " ou " + Rainbow(@@create_cmd).green + " " + Rainbow(@@post_cat).green,
    Rainbow("Attention! toutes les commandes ne sont pas actives mais on y travaille!").yellow,
    "",
    "option globale " + Rainbow(@@verbose_opt).green + " >> pour afficher le processus en cours",
    "",
